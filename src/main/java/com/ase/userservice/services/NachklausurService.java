...
public class NachklausurService {
     ...
     *
     * @param nachklausurRequest the Nachklausur request for which to generate the PDF
     * @return the PDF content as byte array
     * @throws RuntimeException if request is null or PDF generation fails
     */
    public byte[] generateNachklausurPdf(NachklausurRequest nachklausurRequest) {
        ...
        try {
            ...
            // Student information
            String studentInfo = String.format("Name: %s", nachklausurRequest.getName());
            ...
            // Exam information
            String modulInfo = String.format("Modul: %s", nachklausurRequest.getModul());
            ...
            String footerText = "Dieser Antrag wurde maschinell erzeugt. "
                    + "Bitte ausdrucken, ausfüllen, unterschreiben und beim Prüfungsamt einreichen.";
